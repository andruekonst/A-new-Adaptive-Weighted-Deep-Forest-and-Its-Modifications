...
from .sklearn_estimators import GCBaggingExtraTreesClassifier, GCBaggingRandomForestClassifier
#from .xgb_estimator import GCXGBClassifier
from .kfold_wrapper import KFoldWrapper

def get_estimator_class(est_type):
    if est_type == "BaggingExtraTreesClassifier":
        return GCBaggingExtraTreesClassifier
    if est_type == "BaggingRandomForestClassifier":
        return GCBaggingRandomForestClassifier
