...
from .base_estimator import BaseClassifierWrapper, BaseBaggingClassifierWrapper
...
class SKlearnBaseBaggingClassifier(BaseBaggingClassifierWrapper):
    def _load_model_from_disk(self, cache_path):
        return joblib.load(cache_path)
...
class GCBaggingExtraTreesClassifier(SKlearnBaseBaggingClassifier):
    def __init__(self, name, kwargs):
        from sklearn.ensemble import ExtraTreesClassifier
        super(GCBaggingExtraTreesClassifier, self).__init__(name, ExtraTreesClassifier, kwargs)

    def _default_predict_batch_size(self, clf, X):
        return forest_predict_batch_size(clf, X)

class GCBaggingRandomForestClassifier(SKlearnBaseBaggingClassifier):
    def __init__(self, name, kwargs):
        from sklearn.ensemble import RandomForestClassifier
        super(GCBaggingRandomForestClassifier, self).__init__(name, RandomForestClassifier, kwargs)
