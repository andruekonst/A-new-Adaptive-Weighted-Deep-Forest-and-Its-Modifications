...
def save():
    train_imdb = IMDB(data_set="train")
    test_imdb = IMDB(data_set="test")

    X_train, y_train = train_imdb.X, train_imdb.y
    X_test, y_test = test_imdb.X, test_imdb.y

    np.save("datasets/imdb/X_train.npy", X_train)
    np.save("datasets/imdb/X_test.npy", X_test)
    np.save("datasets/imdb/y_train.npy", y_train)
    np.save("datasets/imdb/y_test.npy", y_test)

    print("IMDB Datasets have been successfully saved")
