...
def get_dataset_base():
    ...
    return osp.abspath(osp.join(__file__, osp.pardir, osp.pardir, osp.pardir, "datasets"))
...
def get_dataset_cache_base():
    ...
    return osp.abspath(osp.join(__file__, osp.pardir, osp.pardir, osp.pardir, "datasets-cache"))
